...
<h1 class="text-sm font-semibold tracking-tight">Zeo</h1>
...
<p class="text-[10px] text-text-secondary-light dark:text-text-secondary-dark font-mono">
            Zeo System Status: <span class="text-emerald-600 dark:text-emerald-400 font-bold">Operational</span>
</p>
</div>

</body></html>6:["$","$Lf",null,{"title":"Runner List With Health Badges","children":[["$","div",null,{"className":"mb-3 text-sm text-gray-500","children":["Category: ","Runtime Status"]}],["$","div",null,{"className":"overflow-hidden rounded border border-gray-200 bg-white","children":["$","iframe",null,{"title":"Runner List With Health Badges","srcDoc":"$10","className":"h-[1100px] w-full","sandbox":"allow-scripts allow-same-origin"}]}]]}]
