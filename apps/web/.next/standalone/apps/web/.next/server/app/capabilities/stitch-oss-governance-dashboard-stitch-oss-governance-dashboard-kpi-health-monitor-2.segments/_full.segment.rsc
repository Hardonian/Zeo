...
<section class="px-4 pt-4 pb-2 flex items-center justify-between">
<div class="flex flex-col">
<h2 class="text-gray-900 dark:text-white text-sm font-bold">Analysis Mode</h2>
<p class="text-gray-500 dark:text-gray-400 text-[10px]">Simplify technical metrics</p>
</div>
<label class="inline-flex items-center cursor-pointer">
<input checked="" class="sr-only peer" type="checkbox" value=""/>
<div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary"></div>
<span class="ms-3 text-xs font-medium text-gray-900 dark:text-gray-300">Plain Language</span>
</label>
</section>
...
<p class="text-gray-600 dark:text-gray-300 text-sm mb-4">Metric has flatlined for 4+ hours.</p>
...
<p class="text-gray-600 dark:text-gray-300 text-sm mb-4">Values are fluctuating unpredictably.</p>
...
<button class="bg-white dark:bg-surface-dark text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700 px-4 py-1.5 rounded-full text-sm font-medium whitespace-nowrap hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">Unstable</button>
<button class="bg-white dark:bg-surface-dark text-gray-600 dark:text-gray-400 border border-gray-200 dark:border-gray-700 px-4 py-1.5 rounded-full text-sm font-medium whitespace-nowrap hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">Outdated</button>
</div>
</section>
...
<div>
<p class="text-[10px] text-gray-500 uppercase font-medium">Timeliness</p>
<p class="text-emerald-500 font-mono text-xs font-semibold">Real-time</p>
</div>
<div>
<p class="text-[10px] text-gray-500 uppercase font-medium">Completeness</p>
<p class="text-emerald-500 font-mono text-xs font-semibold">Perfect</p>
</div>
<div>
<p class="text-[10px] text-gray-500 uppercase font-medium">Stability</p>
<p class="text-emerald-500 font-mono text-xs font-semibold">Stable</p>
</div>
</div>
...
<div class="bg-white dark:bg-surface-dark rounded-xl p-4 shadow-sm border border-gray-100 dark:border-gray-800 flex flex-col gap-4 ring-1 ring-amber-500/20">
<div class="flex justify-between items-start">
<div class="flex items-center gap-3">
...
<div class="bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800/30 rounded-lg p-3 text-sm">
<div class="flex gap-2 items-start">
<span class="material-symbols-outlined text-amber-600 dark:text-amber-400 text-base mt-0.5">info</span>
<div>
<p class="text-amber-900 dark:text-amber-100 font-medium text-xs mb-1">Why is this At Risk?</p>
<p class="text-amber-800 dark:text-amber-200/80 text-xs leading-relaxed">
                                We're seeing unpredictable spikes in data. Usually, this metric is steady, but right now it's jumping up and down more than usual (High Error Margin).
                            </p>
</div>
</div>
</div>
...
<div>
<p class="text-[10px] text-gray-500 uppercase font-medium">Timeliness</p>
<p class="text-gray-900 dark:text-white font-mono text-xs font-semibold">Good</p>
</div>
<div>
<p class="text-[10px] text-gray-500 uppercase font-medium">Completeness</p>
<p class="text-amber-500 font-mono text-xs font-semibold">Gaps Found</p>
</div>
<div>
<p class="text-[10px] text-gray-500 uppercase font-medium">Stability</p>
<p class="text-gray-900 dark:text-white font-mono text-xs font-semibold">Unstable</p>
</div>
</div>
<div class="relative h-12 w-full mt-1">
...
<div class="bg-red-50 dark:bg-red-900/10 border border-red-200 dark:border-red-800/30 rounded-lg p-3 text-sm">
<div class="flex gap-2 items-start">
<span class="material-symbols-outlined text-red-600 dark:text-red-400 text-base mt-0.5">report</span>
<div>
<p class="text-red-900 dark:text-red-100 font-medium text-xs mb-1">Critical Issue</p>
<p class="text-red-800 dark:text-red-200/80 text-xs leading-relaxed">
                                We stopped receiving new data 5 hours ago. This metric is now considered unreliable.
                            </p>
</div>
</div>
</div>
...
<div>
<p class="text-[10px] text-gray-500 uppercase font-medium">Timeliness</p>
<p class="text-red-500 font-mono text-xs font-bold">Significantly Delayed</p>
</div>
<div>
<p class="text-[10px] text-gray-500 uppercase font-medium">Completeness</p>
<p class="text-gray-900 dark:text-white font-mono text-xs font-semibold">Incomplete</p>
</div>
<div>
<p class="text-[10px] text-gray-500 uppercase font-medium">Stability</p>
<p class="text-gray-900 dark:text-white font-mono text-xs font-semibold">Erratic</p>
</div>
</div>
...
<div>
<p class="text-[10px] text-gray-500 uppercase font-medium">Timeliness</p>
<p class="text-gray-900 dark:text-white font-mono text-xs font-semibold">Live</p>
</div>
<div>
<p class="text-[10px] text-gray-500 uppercase font-medium">Completeness</p>
<p class="text-gray-900 dark:text-white font-mono text-xs font-semibold">Full Data</p>
</div>
<div>
<p class="text-[10px] text-gray-500 uppercase font-medium">Stability</p>
<p class="text-emerald-500 font-mono text-xs font-semibold">Stable</p>
...
<div class="h-6 w-full bg-white dark:bg-surface-dark fixed bottom-0 z-40"></div> 

</body></html>6:["$","div",null,{"className":"min-h-screen bg-gray-50","children":[["$","header",null,{"className":"bg-white border-b border-gray-200 py-4 px-6 md:px-8 sticky top-0 z-20","children":["$","div",null,{"className":"max-w-7xl mx-auto flex items-center justify-between","children":[["$","div",null,{"className":"flex items-center gap-4","children":[["$","$L5",null,{"href":"/capabilities","className":"p-2 hover:bg-gray-100 rounded-lg text-gray-500 transition-colors","children":["$","svg",null,{"className":"w-5 h-5","fill":"none","viewBox":"0 0 24 24","stroke":"currentColor","children":["$","path",null,{"strokeLinecap":"round","strokeLinejoin":"round","strokeWidth":2,"d":"M10 19l-7-7m0 0l7-7m-7 7h18"}]}]}],["$","div",null,{"children":[["$","h1",null,{"className":"text-lg font-bold text-gray-900 tracking-tight","children":"Kpi Health Monitor 2"}],["$","p",null,{"className":"text-xs text-blue-600 font-medium uppercase tracking-widest","children":"Governance & Compliance"}]]}]]}],["$","div",null,{"className":"flex gap-3","children":["$","div",null,{"className":"hidden sm:flex items-center gap-2 px-3 py-1 bg-yellow-50 text-yellow-700 rounded-full text-xs font-medium border border-yellow-100","children":[["$","span",null,{"className":"w-1.5 h-1.5 rounded-full bg-yellow-500 animate-pulse"}],"Live Preview"]}]}]]}]}],["$","main",null,{"className":"w-full","children":["$","div",null,{"className":"bg-white rounded-none shadow-none overflow-hidden","children":["$","iframe",null,{"title":"Kpi Health Monitor 2","srcDoc":"$f","className":"w-full h-[calc(100vh-65px)] border-none","sandbox":"allow-scripts allow-same-origin"}]}]}]]}]
