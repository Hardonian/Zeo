...
<h2 class="hidden text-sm font-bold leading-tight text-slate-900 dark:text-white plain-term">Risk Overview</h2>
</div>
...
<div class="absolute left-1 top-1 h-4 w-4 rounded-full bg-slate-400 dark:bg-slate-400 transition-transform toggle-dot shadow-sm"></div>
</div>
<span class="text-[9px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 group-hover:text-primary transition-colors">Plain Lang</span>
</label>
</header>
...
<span class="hidden text-xs font-medium uppercase tracking-wider text-primary plain-term">Reliability Score</span>
...
<p class="hidden text-sm text-slate-500 dark:text-slate-400 plain-term">High certainty. Results are consistent within expected ranges.</p>
</div>
...
<span class="hidden font-mono text-sm font-semibold text-slate-900 dark:text-white plain-term leading-7">Very Low</span>
</div>
<div class="flex flex-col gap-1 rounded-lg border border-slate-200 dark:border-slate-800 bg-card-light dark:bg-card-dark p-3 shadow-sm">
<div class="flex items-center gap-2">
...
<span class="hidden font-mono text-sm font-semibold text-slate-900 dark:text-white plain-term leading-7">Stable</span>
</div>
</div>
</div>
<div class="mt-6">
...
<h3 class="hidden text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 plain-term">Risk Factors</h3>
...
<div class="hidden text-xs text-slate-600 dark:text-slate-300 plain-term leading-relaxed">
                            Minor fluctuations in data input. Sensors are calibrated correctly, but there is slight delay (4ms) affecting real-time precision.
                        </div>
...
<span class="hidden font-semibold text-primary plain-term">Market Environment Change</span>
</div>
...
<div class="hidden text-xs text-slate-700 dark:text-slate-200 plain-term leading-relaxed">
...
</body></html>6:["$","div",null,{"className":"min-h-screen bg-gray-50","children":[["$","header",null,{"className":"bg-white border-b border-gray-200 py-4 px-6 md:px-8 sticky top-0 z-20","children":["$","div",null,{"className":"max-w-7xl mx-auto flex items-center justify-between","children":[["$","div",null,{"className":"flex items-center gap-4","children":[["$","$L5",null,{"href":"/capabilities","className":"p-2 hover:bg-gray-100 rounded-lg text-gray-500 transition-colors","children":["$","svg",null,{"className":"w-5 h-5","fill":"none","viewBox":"0 0 24 24","stroke":"currentColor","children":["$","path",null,{"strokeLinecap":"round","strokeLinejoin":"round","strokeWidth":2,"d":"M10 19l-7-7m0 0l7-7m-7 7h18"}]}]}],["$","div",null,{"children":[["$","h1",null,{"className":"text-lg font-bold text-gray-900 tracking-tight","children":"Uncertainty Ledger Viewer 1"}],["$","p",null,{"className":"text-xs text-blue-600 font-medium uppercase tracking-widest","children":"Governance & Compliance"}]]}]]}],["$","div",null,{"className":"flex gap-3","children":["$","div",null,{"className":"hidden sm:flex items-center gap-2 px-3 py-1 bg-yellow-50 text-yellow-700 rounded-full text-xs font-medium border border-yellow-100","children":[["$","span",null,{"className":"w-1.5 h-1.5 rounded-full bg-yellow-500 animate-pulse"}],"Live Preview"]}]}]]}]}],["$","main",null,{"className":"w-full","children":["$","div",null,{"className":"bg-white rounded-none shadow-none overflow-hidden","children":["$","iframe",null,{"title":"Uncertainty Ledger Viewer 1","srcDoc":"$f","className":"w-full h-[calc(100vh-65px)] border-none","sandbox":"allow-scripts allow-same-origin"}]}]}]]}]
