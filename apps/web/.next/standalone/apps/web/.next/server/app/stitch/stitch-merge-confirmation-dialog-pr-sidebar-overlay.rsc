...
10:T3871,<!DOCTYPE html>
<html lang="en"><head>
<meta charset="utf-8"/>
<meta content="width=device-width, initial-scale=1.0" name="viewport"/>
<title>Zeo PR Sidebar Overlay</title>
...
<span class="font-semibold text-sm">zeo / core-api</span>
</div>
</div>
...
<p class="text-center text-[10px] text-gray-400 mt-2">
                        Powered by Zeo Deterministic Policy Engine
                    </p>
</div>
</div>
</div>
...
</body></html>6:["$","$Lf",null,{"title":"Pr Sidebar Overlay","children":[["$","div",null,{"className":"mb-3 text-sm text-gray-500","children":["Category: ","Action Guard"]}],["$","div",null,{"className":"overflow-hidden rounded border border-gray-200 bg-white","children":["$","iframe",null,{"title":"Pr Sidebar Overlay","srcDoc":"$10","className":"h-[1100px] w-full","sandbox":"allow-scripts allow-same-origin"}]}]]}]
