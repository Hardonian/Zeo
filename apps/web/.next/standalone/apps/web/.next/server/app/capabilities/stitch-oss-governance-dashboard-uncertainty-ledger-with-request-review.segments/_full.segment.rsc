...
<span class="text-[10px] font-medium text-slate-400 italic">Consult Researcher for nuance</span><button class="ml-auto text-[10px] font-bold text-primary hover:text-primary/80 flex items-center gap-0.5 underline decoration-primary/30 underline-offset-2" data-action="request-review">
