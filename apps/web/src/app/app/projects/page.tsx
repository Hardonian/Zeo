...
export default async function ProjectsPage({
  ...
  return (
    <div className="space-y-4">
      ...
      <form action={createProject as unknown as string} className="rounded border bg-white p-4"><input className="rounded border px-3 py-2" name="name" placeholder="Project name" required /><button className="ml-2 rounded bg-blue-600 px-3 py-2 text-white">Create</button></form>
