...
export const OAUTH_DEFAULT_PROVIDER = process.env.NEXT_PUBLIC_OAUTH_PROVIDER || 'github';

export const OAUTH_REDIRECT_TO = process.env.NEXT_PUBLIC_OAUTH_REDIRECT_TO || '/app';
