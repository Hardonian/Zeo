...
JobForge is Zeo's deterministic background job system. It ensures that heavy tasks like policy evaluation and static analysis don't block your API handlers.
...
Use the `zeo` CLI to manage jobs:
