      ...
      <Card className="border-destructive/50">
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">
            We encountered an error while loading this policy. The policy may not exist, or you may not have permission to view it.
          </p>
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={() => (window.location.href = '/dashboard/policies')} variant="ghost">
              View All Policies
            </Button>
          </div>
        </CardContent>
