...
- Epistemic honesty: Never convert uncertainty into false precision.
...
## Integration with Existing Zeo Invariants
This Master Pack extends the existing Zeo epistemic model:
- Preserves all Fact/Belief/Assumption/Unknown tagging
- Maintains provenance-first requirements
- Extends robustness analysis to UI/UX decisions
- Adds design token discipline for visual consistency
