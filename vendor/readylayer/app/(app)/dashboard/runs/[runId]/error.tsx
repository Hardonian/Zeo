      ...
      <Card className="border-destructive/50">
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground">
            We encountered an error while loading this test run. The run may not exist, or you may not have permission to view it.
          </p>
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={() => (window.location.href = '/dashboard/runs')} variant="ghost">
              View All Runs
            </Button>
          </div>
        </CardContent>
