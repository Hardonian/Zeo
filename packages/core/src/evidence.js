...
export class ProvenanceRequiredError extends Error {
    constructor(candidateText) {
        super(`Cannot promote FactCandidate to Fact without provenance: "${candidateText}". ` +
 ...
 */
export function promoteFactCandidate(candidate, provenance) {
 ...
 */
export function downgradeTobelief(candidate) {
    return {
        id: candidate.id,
        text: candidate.text,
        status: "belief",
