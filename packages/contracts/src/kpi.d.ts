 ...
 */
import type { ProvenancePointer, ProbabilityInterval, UUID } from "./types.js";
/**
 ...
 */
export type KpiCategory = "decision_quality" | "calibration" | "robustness" | "efficiency" | "epistemic_integrity" | "custom";
/**
...
export type KpiFormula = {
    ...
    type: "custom";
    compute: (data: Record<string, unknown>) => number;
};
/**
 ...
 * KPI error codes
 */
export type KpiErrorCode = "INVALID_INPUT" | "MISSING_DATA" | "COMPUTATION_FAILED" | "INSUFFICIENT_CONFIDENCE" | "PROVENANCE_REQUIRED" | "INVALID_FORMULA" | "CIRCULAR_DEPENDENCY" | "STORAGE_ERROR" | "NOT_FOUND";
/**
 * Standard KPI definitions
 */
export declare const StandardKpis: {
    readonly DECISION_COVERAGE: "decision-coverage";
    readonly CALIBRATION_SCORE: "calibration-score";
    readonly ROBUSTNESS_SCORE: "robustness-score";
    readonly EVIDENCE_COMPLETENESS: "evidence-completeness";
    readonly UNCERTAINTY_WIDTH: "uncertainty-width";
    readonly FORECAST_ACCURACY: "forecast-accuracy";
    readonly BRANCH_DEPTH: "branch-depth";
    readonly VOI_UTILIZATION: "voi-utilization";
};
/**
