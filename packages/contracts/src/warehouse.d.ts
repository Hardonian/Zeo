...
export type WarehouseKind = 'decision' | 'decision-draft' | 'evidence-event' | 'signal-observation' | 'observation-batch' | 'run-result' | 'outcome-record' | 'calibration-report' | 'regime-event' | 'regime-state' | 'kpi-measurement' | 'kpi-dashboard' | 'kpi-alert' | 'kpi-trend' | 'scenario';
