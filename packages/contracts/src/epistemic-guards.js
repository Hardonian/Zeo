 ...
 */
export const MIN_WIDTH_BY_SOURCE = {
    text: 0.2,
    numeric: 0.05,
    expert: 0.1,
    calibrated: 0.1,
 ...
 */
export function enforceWidenOnly(current, proposed, options = {}) {
 ...
 */
export function isWidenOnlyViolation(current, proposed, options = {}) {
    const currentWidth = current.high - current.low;
    const proposedWidth = proposed.high - proposed.low;
    // Check minimum width
    const minWidth = options.minWidth ??
 ...
 */
export function intervalWidth(interval) {
 ...
 */
export function widenInterval(interval, factor) {
...
//# sourceMappingURL=epistemic-guards.js.map