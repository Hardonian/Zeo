export type ZeoErrorCode = "INVALID_INTERVAL" | "MISSING_PROVENANCE" | "WEIGHT_OUT_OF_BOUNDS" | "UNMAPPED_SIGNAL" | "UNSAFE_PANEL" | "NON_DETERMINISTIC_INPUT" | "INTERNAL_ASSERTION" | "DECISION_ERROR" | "UNKNOWN_MESSAGE_TYPE" | "VALIDATION_ERROR" | "FAKE_PRECISION" | "QUAL_OBSERVATION_INVALID" | "QUAL_SCALE_INVALID" | "ASSUMPTION_INVALID" | "BUDGET_REACHED";
